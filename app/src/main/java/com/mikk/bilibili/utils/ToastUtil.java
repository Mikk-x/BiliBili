...
public class ToastUtil {
  ...
  public static void LongToast(final String text) {
    ...
    new Handler(Looper.getMainLooper()).post(() -> Toast.
        makeText(MyApplication.getInstance(), text, Toast.LENGTH_LONG).show());
  }
  ...
  public static void LongToast(final int stringId) {
    ...
    new Handler(Looper.getMainLooper()).post(() -> Toast.
        makeText(MyApplication.getInstance(), stringId, Toast.LENGTH_LONG).show());
  }
  ...
  public static void ShortToast(final int stringId) {
    ...
    new Handler(Looper.getMainLooper()).post(() -> Toast.
        makeText(MyApplication.getInstance(), stringId, Toast.LENGTH_SHORT).show());
  }
}
